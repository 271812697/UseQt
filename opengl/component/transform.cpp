...
namespace component {
    ...
    static  glm::quat eye           { 1.0f, 0.0f, 0.0f, 0.0f };  // wxyz
    static  glm::vec3 world_right   { 1.0f, 0.0f, 0.0f };  // +x axis
    static  glm::vec3 world_up      { 0.0f, 1.0f, 0.0f };  // +y axis
    static  glm::vec3 world_forward { 0.0f, 0.0f,-1.0f };  // -z axis
